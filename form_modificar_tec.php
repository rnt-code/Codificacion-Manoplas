    ...
    <body>
        ...
        <main>
            ...
            <header>
                ...
                <form method="post" action="procesar_modificar_tec.php">
                    <div class="desplazar-tabla">
                        <table>
                            <tr>
                                <td><label for="idtec">ID: </label></td>
                                <td><input class="readonly" type="text" name="idtec" id="idtec" value="<?php echo $id;?>" readonly></td>
                            </tr>
                            <tr>
                                <td><label for="teccodigo">Código:</label></td>
                                <td><input type="text" name="teccodigo" id="teccodigo" value="<?php echo $vec[1];?>" required></td>
                            </tr>
                            <tr>
                                <td><label for="tecnombre">Tecnología:</label></td>
                                <td><input type="text" name="tecnombre" id="tecnombre" value="<?php echo $vec[2];?>"required></td>
                            </tr>
                            <tr>
