<?php
    $idtec = $_POST["idtec"];
    $teccod = $_POST["teccodigo"];
    $tecnom = $_POST["tecnombre"];
    //echo"<br>ID=".$id;

    $sql = "UPDATE tecnologia SET tec_codigo='$teccod', tec_nombre='$tecnom' WHERE id_tec = $idtec";
        ...
        <main>
            ...
            <?php
                if($res) {
                    ...
                    header("Refresh: 0; url=listar_tec.php");
                }
                else {
                    ?>
                    ...
                    //header("Refresh: 6; url=listar_tec.php");
                }
            ?>
        </main>
