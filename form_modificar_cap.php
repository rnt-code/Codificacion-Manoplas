<?php
    ...
    $id = $_GET["id"];
    $sql = "SELECT * FROM capacidad WHERE id_cap = $id";
...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <section>
            <header>
                <h5 hidden>Modificar capacidad</h5>
            </header>
                <form method="post" action="procesar_modificar_cap.php">
                    <div class="desplazar-tabla">
                        <table>
                            <tr>
                                <td><label for="idcap">ID: </label></td>
                                <td><input class="readonly" type="text" name="idcap" id="idcap" value="<?php echo $id;?>" readonly></td>
                            </tr>
                            <tr>
                                <td><label for="capcodigo">Código:</label></td>
                                <td><input type="text" name="capcodigo" id="capcodigo" value="<?php echo $vec[1];?>" required></td>
                            </tr>
                            <tr>
                                <td><label for="capnombre">Capacidad:</label></td>
                                <td><input type="text" name="capnombre" id="capnombre" value="<?php echo $vec[2];?>"required></td>
                            </tr>
                            <tr>
