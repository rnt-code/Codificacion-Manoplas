...
<html lang="es">
    <head>
        ...
        <title>Lista Marcas de Kit</title>
    </head>
    <body>
        <header id="header">
        ...
        <main>
            ...
            <section>
                <header class="subtitulo">
                    <h5>Marcas de Kit disponibles</h5>
                </header>
            </section>
            <hr class="hrcolor">
            <div class="botones">
            ...
            <div class="desplazar-tabla">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="form_modificar_mk.php?id=<?php echo $vec[0];?>">Modificar</a></td>
                        <td><a href="procesar_eliminar_mk.php?id=<?php echo $vec[0];?>">Eliminar</a></td>
                    <?php		
                    }
                    ?>
                    </tr>
