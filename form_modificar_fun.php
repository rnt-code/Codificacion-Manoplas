...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <section>
            <header>
                <h5 hidden>Modificar función</h5>
            </header>
                <form method="post" action="procesar_modificar_fun.php">
                    <div class="desplazar-tabla">
                        <table>
                            <tr>
                                <td><label for="idfun">ID: </label></td>
                                <td><input class="readonly" type="text" name="idfun" id="idfun" value="<?php echo $id;?>" readonly></td>
                            </tr>
                            <tr>
                                <td><label for="funcodigo">Código:</label></td>
                                <td><input type="text" name="funcodigo" id="funcodigo" value="<?php echo $vec[1];?>" required></td>
                            </tr>
                            <tr>
                                <td><label for="funnombre">Función:</label></td>
                                <td><input type="text" name="funnombre" id="funnombre" value="<?php echo $vec[2];?>"required></td>
                            </tr>
                            <tr>
