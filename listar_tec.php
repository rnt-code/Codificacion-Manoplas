        ...
        <main>
            ...
            <div class="botones">
                <div class="d-flex bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        <td><button class="btn btn-outline-primary btn-sm" type="button" onclick="location.href='form_alta_tec.php'">Agregar tecnología</button></td>
                    </div>
                </div>
            </div>
            <hr class="hrcolor">
            <div class="desplazar-tabla">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="form_modificar_tec.php?id=<?php echo $vec[0];?>">Modificar</a></td>
                        <td><a href="procesar_eliminar_tec.php?id=<?php echo $vec[0];?>">Eliminar</a></td>
                    <?php		
                    }
                    ?>
                    </tr>
