        ...
        <main>
            ...
            <div class="botones">
                <div class="p-2 bd-highlight">
                    ...
                    <td><button class="btn btn-outline-primary btn-sm" type="button" onclick="location.href='form_alta_fun.php'">Agregar función</button></td>
                </div>
            </div>
            <hr class="hrcolor">
            <div class="desplazar-tabla">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="form_modificar_fun.php?id=<?php echo $vec[0];?>">Modificar</a></td>
                        <td><a href="procesar_eliminar_fun.php?id=<?php echo $vec[0];?>">Eliminar</a></td>
                    <?php		
                    }
                    ?>
                    </tr>
